...
@section('content')
    <a class="btn btn-primary my-3" href="{{ route('categoriestaches.create') }}">@include('include.iconeAjout') Ajouter une catégorie de tâche <span class="fas fa-baby"></span></a>
